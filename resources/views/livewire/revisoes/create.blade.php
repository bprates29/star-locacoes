                    ...
                    <div class="">
                        <div class="mb-4">
                            <label for="exampleFormControlInput2"
                                   class="block text-gray-700 text-sm font-bold mb-2">Data revisão:</label>
                            <input type="date"
                        ...
                        <div class="mb-4">
                            <label for="exampleFormControlInput2"
                                   class="block text-gray-700 text-sm font-bold mb-2">Km do carro: </label>
                            <input type="text"
                                   class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        ...
                        <div class="mb-4">
                            <label for="exampleFormControlInput2"
                                   class="block text-gray-700 text-sm font-bold mb-2">Óleo:</label>
                            <input type="text"
                                   class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
